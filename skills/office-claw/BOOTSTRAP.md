...
| `docx-craft` | 创建和编辑专业 DOCX 文档，支持研究与会议纪要生成 |
| `official-doc-formatter` | 按国标公文规范格式化 Word 文档 |
| `pptx-craft` | 多阶段研究、规划、生成一体化 PPT 流程 |
| `ppt-template-generate` | 从现有 PPTX 提取风格，生成可复用模板规范 |
| `pptx-content-summarizer` | 从已有 PPT/PPTX 提取文本内容并生成 Markdown 摘要 |
